            ...
            <article>
                <div class="articleWrap">
                    <div class="paperDetailWrap">
                        <div class="titleWrap">
                            <p class="title">상담톡 포인트 충전</p>
                        </div>
                        <div class="detailContent">
                          <div class="tableWrap">
                            <div class="btnWrap searchWrap">
                              <table summary="상담톡 포인트 충전">
                                  <caption class="blind">상담톡 포인트 충전</caption>
                                  <colgroup>
                                    <col style="width:10%;">
                                    <col style="width:10%;">
                                    <col style="width:10%;">
    ...
    get () {
      if (this.userMenuAuth.retrieve_list) {
        ...
        this.http
          ...
          .catch(e => {
            console.log('ConsultingTalkPoint.vue : ' + e)
          })
      }
    },
    set () {
      if (this.userMenuAuth.create_data || this.userMenuAuth.modify_data) {
        if (this.validate()) {
          this.isLoading = true
          this.http
            .post('/DataCorrection/BizMessage/increasePoints',
              {
            ...
            .then(result => {
              // console.log(result.data)
              this.isLoading = false
              let msg = '상담톡 포인트 충전처리 되었습니다.'
              if (result.data.resultCode !== 0) {
                msg = '상담톡 포인트 충전처리 실패했습니다.'
              }
